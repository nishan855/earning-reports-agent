...
ok("shows CVD ratio", "CVD RATIO" in rc or "rolling average" in rc)
ok("shows bias", "BUYERS" in rc or "SELLERS" in rc or "NEUTRAL" in rc)
ok("shows direction", "CVD DIRECTION" in rc or "RISING" in rc or "FALLING" in rc or "FLAT" in rc or "INSUFFICIENT" in rc)
